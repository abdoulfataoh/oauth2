...
@router.post('/oauth2/client', response_model=S.Client,)
...
@router.get('/oauth2/clients', response_model=list[S.Client])
...
@router.get('/oauth2/client/{client_id}', response_model=S.Client)
...
@router.delete('/oauth2/client/{client_id}')
